...
$GLOBALS['TL_LANG']['tl_domain_manager_installation']['external_services'] = ['Externe Dienste', 'Optionale externe Dienste auswählen, denen diese Installation zugeordnet ist.'];
$GLOBALS['TL_LANG']['tl_domain_manager_installation']['trakked'] = ['Trakked (Legacy)', 'Altes Feld aus Version 1.4; wird bei der Migration automatisch übernommen.'];
