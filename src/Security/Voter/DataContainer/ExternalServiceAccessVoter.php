...
/**
 * Authoritative voter for external Domain Manager services.
 */
final class ExternalServiceAccessVoter extends Voter
{
    private const TABLE = 'tl_domain_manager_external_service';
    private const MODULE = 'domain_manager_services';
